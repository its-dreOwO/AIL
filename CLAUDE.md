...
- **Dataset:** local copy at `/home/dre/Downloads/hik_dataset/data` (3.9GB) — rsync `poses`+`scenes` to a fresh VM at `~/hik_dataset/` (~2-6 MB/s, ~20-30 min). Also on the Modal volume `humof-data` (raw + preprocessed).
